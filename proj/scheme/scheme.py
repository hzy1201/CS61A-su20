...
class Frame(object):
    ...
    def make_child_frame(self, formals, vals):
        ...
        child = Frame(self)
        pt1, pt2 = formals, vals
        while pt1 is not nil:
            child.define(pt1.first, pt2.first)
            pt1 = pt1.rest
            pt2 = pt2.rest
        return child
        # END PROBLEM 10
...
def do_and_form(expressions, env):
    ...
    if pt1 is nil:
        return True
    while (pt1 is not nil):
        value = scheme_eval(pt1.first, env)
...
def make_let_frame(bindings, env):
    ...
    #return env.make_child_frame(names)
    # END PROBLEM 14
