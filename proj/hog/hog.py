    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            if feral_hogs and abs(num_rolls - last0) == 2:
                score0 += 3
            ans0 = take_turn(num_rolls, score1, dice)
            score0 += ans0
            last0 = ans0
            ...
            if feral_hogs and abs(num_rolls - last1) == 2:
                score1 += 3
            ans1 = take_turn(num_rolls, score0, dice)
            score1 += ans1
            last1 = ans1
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def announce(score0, score1):
        ...
        if delta > running_high:
            print("{} point(s)! That's the biggest gain yet for Player {}".format(delta, who))
            return announce_highest(who, score, delta)
        else:
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if is_swap(score + bonus, opponent_score) and opponent_score > score + bonus:
        return 0

    if bonus >= cutoff:
        if (is_swap(score + bonus, opponent_score) == False):
            return 0
        else:
            if opponent_score >= score + bonus:
                return 0
